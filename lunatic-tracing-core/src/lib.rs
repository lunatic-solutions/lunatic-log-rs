...
/// For example:
/// ```rust
/// use lunatic_tracing_core::{callsite, identify_callsite};
/// # use lunatic_tracing_core::{Metadata, collect::Interest};
/// # fn main() {
...
/// /// For example:
/// ```rust
/// # use lunatic_tracing_core::{callsite::Callsite, collect::Interest};
/// use lunatic_tracing_core::metadata;
/// use lunatic_tracing_core::metadata::{Kind, Level, Metadata};
/// # fn main() {
/// # pub struct MyCallsite { }
