...
impl Event {
    ...
    pub fn dispatch(metadata: Metadata, fields: field::ValueSet) {
    ...
    /// and set of values.
    #[inline]
    pub fn new(metadata: Metadata, fields: field::ValueSet) -> Self {
        Event {
            fields,
            metadata,
    ...
    pub fn child_of(parent: impl Into<Option<Id>>, metadata: Metadata, fields: field::ValueSet) {
    ...
    // pub fn fields(&self) -> field::Iter<'_> {
