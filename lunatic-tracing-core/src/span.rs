...
#[derive(Debug, Serialize, Deserialize)]
enum CurrentInner {
    Current { id: Id, metadata: Metadata },
    None,
    Unknown,
}
...
impl Attributes {
    ...
    pub fn new(metadata: Metadata, values: field::ValueSet) -> Self {
        Attributes {
            metadata,
            values,
    ...
    pub fn new_root(metadata: Metadata, values: field::ValueSet) -> Self {
        Attributes {
            metadata,
            values,
            parent: Parent::Root,
    ...
    pub fn child_of(parent: Id, metadata: Metadata, values: field::ValueSet) -> Self {
        Attributes {
            metadata,
            values,
...
impl Record {
    ...
    pub fn new(values: field::ValueSet) -> Self {
        Self { values }
    }
...
impl Current {
    ...
    pub fn into_inner(self) -> Option<(Id, Metadata)> {
        match self.inner {
...
impl<'a> From<&'a Current> for Option<&'a Metadata> {
    fn from(cur: &'a Current) -> Self {
        cur.metadata()
    }
}
