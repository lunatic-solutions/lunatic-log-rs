...
/// For example:
/// ```
/// use lunatic_tracing_core::Level;
///
...
/// For example:
/// ```
/// use lunatic_tracing_core::{Level, LevelFilter};
///
...
///
/// ```
/// use lunatic_tracing_core::{span, Event, Level, LevelFilter, Collect, Metadata};
/// # use lunatic_tracing_core::span::{Id, Record, Current};
///
/// #[derive(Debug)]
...
impl LevelFilter {
    ...
    pub fn set_max(LevelFilter(level): LevelFilter) {
        let val = match level {
