...
pub use lunatic_tracing_core::dispatch::set_default;
#[cfg(feature = "std")]
#[cfg_attr(docsrs, doc(cfg(feature = "std")))]
pub use lunatic_tracing_core::dispatch::with_default;
#[cfg(feature = "std")]
#[cfg_attr(docsrs, doc(cfg(feature = "std")))]
pub use lunatic_tracing_core::dispatch::DefaultGuard;
pub use lunatic_tracing_core::dispatch::{
...
#[doc(hidden)]
pub use lunatic_tracing_core::dispatch::has_been_set;
