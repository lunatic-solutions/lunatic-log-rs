...
//     enabled: fn(VRef<SubscriberVTable>, metadata: &Metadata) -> bool,
//     event: fn(VRef<SubscriberVTable>, event: &tracing::Event),
...
mod Subscriber_vtable_mod {
    use crate::{metadata::Metadata, Event};

    use super::*;
    use ::vtable::*;

    pub struct SubscriberVTable {
        pub enabled: unsafe extern "C" fn(VRef<SubscriberVTable>, metadata: &Metadata) -> bool,
        pub event: unsafe extern "C" fn(VRef<SubscriberVTable>, event: Event),
        ...
        pub fn new<T: Subscriber>() -> Self {
            Self {
                ...
                event: {
                    ...
                    extern "C" fn event<T: Subscriber>(_0: VRef<SubscriberVTable>, _1: Event) {
    ...
    pub trait Subscriber {
        fn enabled(&self, _1: &Metadata) -> bool;

        fn event(&self, _1: Event);
    }
    ...
    impl SubscriberTO {
        pub fn enabled(&self, _1: &Metadata) -> bool {
            unsafe {
                let vtable = self.vtable.as_ref();
                let func = vtable.enabled;
                func(
        ...
        pub fn event(&self, _1: Event) {
            unsafe {
                let vtable = self.vtable.as_ref();
                let func = vtable.event;
                func(
                    <VRef<SubscriberVTable>>::from_raw(self.vtable, self.ptr),
                    _1,
                )
    ...
    ($(#[$meta:meta])* $vis:vis static$ident:ident for$ty:ty) => {
            $(#[$meta])* $vis static $ident: $crate::subscriber::SubscriberVTable = {
                ...
                $crate::subscriber::SubscriberVTable {
                    enabled: {
                        extern "C" fn enabled<T:Subscriber>(_0: VRef<$crate::subscriber::SubscriberVTable>, _1: &$crate::metadata::Metadata) -> bool {
                            unsafe {
                ...
                event: {
                    #[allow(improper_ctypes_definitions)]
                    extern "C" fn event<T:Subscriber>(_0:VRef<$crate::subscriber::SubscriberVTable>, _1: $crate::Event){
                        unsafe {
